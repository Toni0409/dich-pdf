...
# ── Hằng số ───────────────────────────────────────────────────────────────────
API_KEY      = "AIzaSyBGT_fMfYSL2IikPOJEUMYi6iwe9sZPtgY"
...
<style>
    ...
    .stat-val { font-size: 1.5rem; font-weight: bold; color: #e2e8f0; }
    ...
    .stButton > button:hover { background-color: #a78bfa; }
    .stSelectbox label, .stTextInput label { color: #94a3b8 !important; }
    div[data-testid="stFileUploader"] { border: 1.5px dashed #2d3149; border-radius: 10px; padding: 8px; }
</style>
